  ...
  @component('components.form')
    ...
    @slot('input_form')
      ...
      @component('components.input-field')
          ...
          @isset($item->capacity)
            @slot('input_value') {{ $item->capacity }} @endslot 
          @endisset
      @endcomponent

      {{-- FASILITAS --}}
      @component('components.input-field')
          @slot('input_label', 'Fasilitas')
          @slot('input_type', 'textarea')
          @slot('input_name', 'facilities')   {{-- FIXED HERE --}}
          @isset($item->facilities)
            @slot('input_value') {{ $item->facilities }} @endslot
          @endisset
      @endcomponent
